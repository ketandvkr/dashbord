...
const PnlBox = () => (
  <div className="w-[100px] h-[139px] bg-gray-200 border border-gray-400 flex flex-col items-center justify-center rounded-lg">
...
const Pnl7 = () => (
  <div className="w-[100px] h-[139px] bg-gray-200 border border-gray-400 flex flex-col items-center justify-center rounded-lg">
    ...
    <span className="text-center text-green-500 font-bold">30.00</span>
...
const RedBox = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="w-[403px] h-[478px] bg-blue-500 rounded-lg p-4">
        <div className="w-full h-[46px] bg-yellow-500 flex items-center justify-center rounded-lg mb-2">
          PNL Analysis
        </div>
        <div className="relative w-full h-[49.79px]">
          <img className="w-full h-full object-cover rounded-lg" src={pl} alt="pl bg-black" />
          <button
            className="absolute top-0 right-0 w-[113.9px] h-[49.79px] bg-black text-white flex items-center justify-center rounded-lg"
            onClick={() => setDropdownOpen(!dropdownOpen)}
          >
            USD
          </button>
          {dropdownOpen && (
            <div className="absolute top-[49.79px] right-0 mt-1 w-[113.9px] bg-black text-white rounded-lg">
              <ul className="list-none p-2">
                <li className="p-2 hover:bg-gray-700">Option 1</li>
                <li className="p-2 hover:bg-gray-700">Option 2</li>
                <li className="p-2 hover:bg-gray-700">Option 3</li>
              </ul>
            </div>
          )}
        </div>
        <div className="w-full h-[75px] border-2 border-black flex flex-col items-center justify-center mt-2 rounded-lg">
        ...
        <div className="w-full h-[75px] flex items-center justify-between mt-4">
          <button className="font-bold text-xl hover:bg-slate-600 p-2 rounded-lg">
            <img src={deposit} alt="deposit" />
          </button>
          <button className="text-lg font-bold bg-slate-600 rounded-lg text-white hover:bg-slate-700 p-2">
            <img src={ref} alt="ref" />
          </button>
          <button className="text-3xl font-bold hover:bg-slate-600 p-2 rounded-lg">
